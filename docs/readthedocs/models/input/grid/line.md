...
A list with some standard line types can be found here: [Standard Line Types](https://powersystemdatamodel.readthedocs.io/en/latest/models/input/grid/line.html#Standard-Line-Types)_
