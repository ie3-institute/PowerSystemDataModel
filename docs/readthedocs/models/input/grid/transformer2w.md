...
Following there are some standard two winding transformer types with their source. To retrieve the data call the method `TypeSource.getStandardTransformer2WTypes()`.
