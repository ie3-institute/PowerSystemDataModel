...
public abstract class ConnectorInput extends AssetInput implements Nodes {
     ...
     */
    public ConnectorInput(UUID uuid,
     ...
     * @param noOfParallelDevices Amount of parallel devices
     */
    public ConnectorInput(UUID uuid, String id, NodeInput nodeA, NodeInput nodeB, int noOfParallelDevices) {
        super(uuid, id);
        this.nodeA = nodeA;
        this.nodeB = nodeB;
        this.noOfParallelDevices = noOfParallelDevices;
    ...
    public boolean equals(Object o) {
        ...
        return noOfParallelDevices == that.noOfParallelDevices && nodeA.equals(that.nodeA) && nodeB.equals(that.nodeB);
    }
    ...
    public String toString() {
        return "ConnectorInput{" + "nodeA=" + nodeA + ", nodeB=" + nodeB + ", noOfParallelDevices=" +
               noOfParallelDevices + '}';
    }
}
