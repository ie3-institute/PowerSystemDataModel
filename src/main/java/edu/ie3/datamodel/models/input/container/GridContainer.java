...
public abstract class GridContainer implements InputContainer {
    ...
    protected GridContainer(String gridName,
    ...
    public boolean equals(Object o) {
        ...
        return gridName.equals(that.gridName) && rawGrid.equals(that.rawGrid) &&
               systemParticipants.equals(that.systemParticipants) && graphics.equals(that.graphics);
    }
