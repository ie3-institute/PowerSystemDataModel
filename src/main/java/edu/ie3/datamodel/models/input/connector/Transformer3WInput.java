...
public class Transformer3WInput extends TransformerInput {
     ...
     */
    public Transformer3WInput(UUID uuid,
        ...
        this.type = type;
        this.nodeC = nodeC;
        this.nodeInternal = new NodeInput(UUID.randomUUID(), operationTime, operator, "internal_node_" + id,
                        Quantities.getQuantity(1d, PU), false, null, nodeA.getVoltLvl(), nodeA.getSubnet());
    }
    ...
    public Transformer3WInput(UUID uuid,
        ...
        this.type = type;
        this.nodeC = nodeC;
        this.nodeInternal = new NodeInput(UUID.randomUUID(), getOperationTime(), getOperator(), "internal_node_" + id,
                        Quantities.getQuantity(1d, PU), false, null, nodeA.getVoltLvl(), nodeA.getSubnet());
    }
    ...
    public List<NodeInput> getNodes() {
        return Collections.unmodifiableList(Arrays.asList(super.getNodeA(), super.getNodeB(), nodeC));
    }
