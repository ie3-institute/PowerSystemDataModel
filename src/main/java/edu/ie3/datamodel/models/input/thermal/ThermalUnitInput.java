...
public abstract class ThermalUnitInput extends ThermalInput implements HasThermalBus {
  ...
  protected ThermalUnitInput(ThermalInput thermalInput, ThermalBusInput thermalBus) {
    super(thermalInput);
    this.thermalBus = thermalBus;
  }

  protected ThermalUnitInput(ThermalUnitInput other) {
    super(other);
    this.thermalBus = other.thermalBus;
  }
