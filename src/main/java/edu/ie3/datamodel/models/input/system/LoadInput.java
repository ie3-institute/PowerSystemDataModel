...
public class LoadInput extends SystemParticipantInput {
     ...
     * @param node                    the asset is connected to
     * @param qCharacteristics        Description of a reactive power characteristic
     * @param bdewStandardLoadProfile {@link edu.ie3.datamodel.models.BdewLoadProfile} load profile key
     * @param dsm                     True, if demand side management is activated for this load
     * @param eConsAnnual             Annually consumed energy (typically in kWh)
     * @param sRated                  Rated apparent power (in kVA)
     * @param cosphiRated             Rated power factor
    ...
    public LoadInput(UUID uuid,
                     ...
                     Quantity<Power> sRated,
                     double cosphiRated) {
        this(uuid, operationTime, operator, id, node, qCharacteristics, BdewLoadProfile.get(bdewStandardLoadProfile),
                        dsm, eConsAnnual, sRated, cosphiRated);
    }
    ...
    public LoadInput(UUID uuid,
                     ...
                     Quantity<Power> sRated,
                     double cosphiRated) {
        this(uuid, id, node, qCharacteristics, BdewLoadProfile.get(bdewStandardLoadProfile), dsm, eConsAnnual, sRated,
                        cosphiRated);
    }
    ...
    public boolean equals(Object o) {
        ...
        return dsm == loadInput.dsm && Double.compare(loadInput.cosphiRated, cosphiRated) == 0 &&
               eConsAnnual.equals(loadInput.eConsAnnual) && sRated.equals(loadInput.sRated);
    }
    ...
    public String toString() {
        return "LoadInput{" + "dsm=" + dsm + ", eConsAnnual=" + eConsAnnual + ", sRated=" + sRated + ", cosphiRated=" +
               cosphiRated + '}';
    }
}
