...
public class TimeSeriesContainer {
    ...
    public TimeSeriesContainer(Set<IndividualTimeSeries<WeatherValue>> weather, Set<IndividualTimeSeries<EnergyPriceValue>> energyPrice, Set<IndividualTimeSeries<HeatAndSValue>> heatAndApparentPower, Set<IndividualTimeSeries<HeatAndPValue>> heatAndActivePower, Set<IndividualTimeSeries<HeatDemandValue>> heat, Set<IndividualTimeSeries<SValue>> apparentPower, Set<IndividualTimeSeries<PValue>> activePower) {
        this.weather = Objects.requireNonNull(weather, "Weather time series may not be null.");
        this.energyPrice = Objects.requireNonNull(energyPrice, "Energy price time series may not be null.");
        this.heatAndApparentPower = Objects.requireNonNull(heatAndApparentPower, "Heat and apparent power time series may not be null.");
        this.heatAndActivePower = Objects.requireNonNull(heatAndActivePower, "Heat and active power time series may not be null.");
        this.heat = Objects.requireNonNull(heat, "Heat time series may not be null.");
        this.apparentPower = Objects.requireNonNull(apparentPower, "Apparent power time series may not be null.");
        this.activePower = Objects.requireNonNull(activePower, "Active power time series may not be null.");
    }
    ...
    public Set<Set<? extends IndividualTimeSeries<? extends Value>>> getAll() {
       return Stream.of(weather,
                energyPrice,
                heatAndApparentPower,
                heatAndActivePower,
                heat,
                apparentPower,
                activePower).collect(Collectors.toSet());
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(weather, energyPrice, heatAndApparentPower, heatAndActivePower, heat, apparentPower, activePower);
    }
    ...
    public String toString() {
        return "TimeSeriesContainer{" +
                ...
                ", #energyPrice=" + energyPrice.size() +
                ", #heatAndApparentPower=" + heatAndApparentPower.size() +
                ", #heatAndActivePower=" + heatAndActivePower.size() +
                ", #heat=" + heat.size() +
                ", #apparentPower=" + apparentPower.size() +
                ", #activePower=" + activePower.size() +
                '}';
    }
}
