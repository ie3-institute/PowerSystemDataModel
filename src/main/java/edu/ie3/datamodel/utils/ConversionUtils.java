...
public final class ConversionUtils {
  ...
  public static ComparableQuantity<Dimensionless> getDimensionless(
      Map<String, String> fieldsToAttributes, String field) {
  ...
  public static OperationTime buildOperationTime(
      Map<String, String> fieldsToAttributes, String operatesFrom, String operatesUntil) {
