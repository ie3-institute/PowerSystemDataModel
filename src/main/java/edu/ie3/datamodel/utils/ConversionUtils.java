...
public final class ConversionUtils {
     ...
     */
    public static <Q extends Quantity<Q>> ComparableQuantity<Q> getQuantity(Map<String, String> fieldsToAttributes, String field, Unit<Q> unit) {
    ...
    public static <E extends Entity> E getEntity(Map<String, String> fieldsToAttributes, String field, Map<UUID, E> entities) {
     ...
     */
    private static Optional<Geometry> getGeometry(Map<String, String> fieldsToAttributes, String field) {
        String value = getField(fieldsToAttributes, field);
     ...
     */
    public VoltageLevel getVoltageLvl(Map<String, String> fieldsToAttributes, String voltLvlField, String ratedVoltField) {
        try {
            final String voltLvlId = getField(fieldsToAttributes, voltLvlField);
            final ComparableQuantity<ElectricPotential> vRated = getQuantity(fieldsToAttributes, ratedVoltField, KILOVOLT);
    ...
    public static OperationTime buildOperationTime(Map<String, String> fieldsToAttributes, String operatesFrom, String operatesUntil) {
        final String from = getFieldOptional(fieldsToAttributes, operatesFrom).orElse(null);
        final String until = getFieldOptional(fieldsToAttributes, operatesUntil).orElse(null);
