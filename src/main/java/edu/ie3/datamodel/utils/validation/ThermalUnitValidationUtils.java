...
public class ThermalUnitValidationUtils extends ValidationUtils {
  ...
  public static void checkThermalHouse(ThermalHouseInput thermalHouseInput) {
    ...
    if (thermalHouseInput.getEthLosses() == null)
      throw new InvalidEntityException("Thermal losses of thermalHouseInput is null", thermalHouseInput);
    //Check if ethCapa is null
    if (thermalHouseInput.getEthCapa() == null)
      throw new InvalidEntityException("Thermal capacity of thermalHouseInput is null", thermalHouseInput);
    //Check for zero or negative quantities
    detectZeroOrNegativeQuantities(
            new Quantity<?>[] {
                    thermalHouseInput.getEthCapa(), thermalHouseInput.getEthLosses()
            },
            thermalHouseInput);
  }
   ...
   * - its minimum permissible storage volume is not null, positive and not greater than the available storage volume <br>
   * - its inlet temperature is not null and not smaller than the outlet temperature <br>
   * - its outlet/return temperature is not null and equal to / greater than the inlet temperature <br>
  ...
  public static void checkCylindricalStorage(CylindricalStorageInput cylindricalStorageInput) {
    ...
    if ((cylindricalStorageInput.getStorageVolumeLvl() == null)
      ...
      throw new InvalidEntityException("at least one value of cylindricalStorageInput is null", cylindricalStorageInput);
    ...
    if (cylindricalStorageInput.getInletTemp().isLessThan(cylindricalStorageInput.getReturnTemp()))
      throw new InvalidEntityException("Inlet temperature of cylindricalStorageInput cannot be lower than outlet temperature",
              cylindricalStorageInput);
    if (cylindricalStorageInput.getStorageVolumeLvlMin().isGreaterThan(cylindricalStorageInput.getStorageVolumeLvl()))
      throw new InvalidEntityException("Minimum permissible storage volume of cylindricalStorageInput cannot be higher than overall available storage volume",
              cylindricalStorageInput);
