...
public class GridAndGeoUtils extends GeoUtils {
    ...
    /**
     * Builds a straight line string between the both nodes that can be compared safely even if the two
     * provided nodes contain exactly equal coordinates
     *
     * @param a Starting point of the line string
     * @param b Ending point of the line string
     * @return The equivalent straight line string
    ...
    public static LineString buildSafeLineStringBetweenPoints(final Point p1, final Point p2) {
        ...
        return DEFAULT_GEOMETRY_FACTORY
                        .createLineString(ArrayUtils.addAll(safePoint1.getCoordinates(), p2.getCoordinates()));
    }
     ...
     * @return
     */
    public static LineString buildSafeLineStringBetweenCoords(final Coordinate c1, final Coordinate c2) {
        final Coordinate safeCoord1 = c1.equals(c2) ? buildSafeCoord(c1) : c1;
        return DEFAULT_GEOMETRY_FACTORY.createLineString(ArrayUtils.addAll(new Coordinate[] { safeCoord1 }, c2));
    }
