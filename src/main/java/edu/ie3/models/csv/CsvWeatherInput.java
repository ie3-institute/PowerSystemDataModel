...
public class CsvWeatherInput {
  ...
  @CsvBindByName Integer koordinatenid;
  @CsvBindByName Double diffusstrahlung;
  @CsvBindByName Double direktstrahlung;
  @CsvBindByName Double temperatur;
  @CsvBindByName Double windrichtung;
  @CsvBindByName Double windgeschwindigkeit;
