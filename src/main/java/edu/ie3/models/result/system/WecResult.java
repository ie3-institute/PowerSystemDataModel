...
/** Represents calculation results of a {@link edu.ie3.models.input.system.WecInput} */
public class WecResult extends SystemParticipantResult {
   ...
   */
  public WecResult(ZonedDateTime timestamp, UUID inputModel, Quantity<Power> p, Quantity<Power> q) {
