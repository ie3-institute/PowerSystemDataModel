...
/** Represents calculation results of a {@link edu.ie3.models.input.system.ChpInput} */
public class ChpResult extends SystemParticipantResult {
   ...
   */
  public ChpResult(ZonedDateTime timestamp, UUID inputModel, Quantity<Power> p, Quantity<Power> q) {
