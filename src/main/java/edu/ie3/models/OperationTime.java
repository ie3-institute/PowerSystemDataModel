...
/** Time for which something is operated, can be limited to a time frame with one or two bounds or not limited*/
public class OperationTime {
    ...
    /**
     * @return Optional.empty(), if the time frame is unlimited <br><br>
     *   Optional.of(ClosedInterval(startDate, endDate)), if the upper and lower bound is set <br><br>
     *       Optional.of((ClosedInterval(startDate, LocalDateTime.MAX)), if only the lower bound is set <br><br>
    ...
    /** Builder class for {@link edu.ie3.models.OperationTime} */
    public static class OperationTimeBuilder {
        ...
        /** Build an {@link edu.ie3.models.OperationTime} instance from the given parameters <br>
