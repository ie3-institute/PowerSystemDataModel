...
public class Neo4JMapper {
   ...
   public static NodeInput toNodeInput(Neo4JNodeInput neo4JNode) {
       ...
       Point coordinate =
               (neo4JNode.getX_coord() != null && neo4JNode.getY_coord() != null) ? CoordinateUtils.xyCoordToPoint(neo4JNode.getX_coord(), neo4JNode.getY_coord()) : null;
       ...
       ZonedDateTime operatesFrom = neo4JNode.getOperates_from()!= null ? ZonedDateTime.ofInstant(neo4JNode.getOperates_from().toInstant(), ZoneId.of("UTC")) : null;
       ZonedDateTime operatesUntil = neo4JNode.getOperates_until()!= null ? ZonedDateTime.ofInstant(neo4JNode.getOperates_until().toInstant(), ZoneId.of("UTC")) : null;
       ...
       return new NodeInput(uuid, operationTime, null, id, vTarget, vRated, isSlack, coordinate, voltLvl, subnet);
   }
    ...
    public static LineInput toLineInput(Neo4JLineInput neo4JLine, NodeInput nodeA, NodeInput nodeB) {
        ...
        ZonedDateTime operatesFrom = neo4JLine.getOperates_from()!= null ? ZonedDateTime.ofInstant(neo4JLine.getOperates_from().toInstant(), ZoneId.of("UTC")) : null;
        ZonedDateTime operatesUntil = neo4JLine.getOperates_until()!= null ? ZonedDateTime.ofInstant(neo4JLine.getOperates_until().toInstant(), ZoneId.of("UTC")) : null;
    ...
    public static SwitchInput toSwitchInput(Neo4JSwitchInput neo4JSwitch, NodeInput nodeA, NodeInput nodeB) {
        String uuidString = neo4JSwitch.getUuid();
        String id = neo4JSwitch.getId();
        Boolean closed = neo4JSwitch.getClosed();
        ZonedDateTime operatesFrom = neo4JSwitch.getOperates_from()!= null ? ZonedDateTime.ofInstant(neo4JSwitch.getOperates_from().toInstant(), ZoneId.of("UTC")) : null;
        ZonedDateTime operatesUntil = neo4JSwitch.getOperates_until()!= null ? ZonedDateTime.ofInstant(neo4JSwitch.getOperates_until().toInstant(), ZoneId.of("UTC")) : null;
    ...
    public static Transformer2WInput toTransformer2W(Neo4JTransformerInput neo4JTransformer, NodeInput nodeA, NodeInput nodeB) {
        String uuidString = neo4JTransformer.getUuid();
        String id = neo4JTransformer.getId();
        ZonedDateTime operatesFrom = neo4JTransformer.getOperates_from()!= null ? ZonedDateTime.ofInstant(neo4JTransformer.getOperates_from().toInstant(), ZoneId.of("UTC")) : null;
        ZonedDateTime operatesUntil = neo4JTransformer.getOperates_until()!= null ? ZonedDateTime.ofInstant(neo4JTransformer.getOperates_until().toInstant(), ZoneId.of("UTC")) : null;
    ...
    public static Transformer3WInput toTransformer3W(Neo4JTransformerInput neo4JTransformer, NodeInput nodeA, NodeInput nodeB, NodeInput nodeC) {
        String uuidString = neo4JTransformer.getUuid();
        String id = neo4JTransformer.getId();
        ZonedDateTime operatesFrom = neo4JTransformer.getOperates_from()!= null ? ZonedDateTime.ofInstant(neo4JTransformer.getOperates_from().toInstant(), ZoneId.of("UTC")) : null;
        ZonedDateTime operatesUntil = neo4JTransformer.getOperates_until()!= null ? ZonedDateTime.ofInstant(neo4JTransformer.getOperates_until().toInstant(), ZoneId.of("UTC")) : null;
