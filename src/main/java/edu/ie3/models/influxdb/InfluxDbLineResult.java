...
public class InfluxDbLineResult extends InfluxDbEntity<LineResult> {
    ...
    public InfluxDbLineResult(Instant time, String input_uuid, String uuid, Double iAMag, Double iAAng, Double iBMag, Double iBAng) {
        super(time);
    ...
    public InfluxDbLineResult(LineResult lineResult){
        ...
        this.input_uuid = lineResult.getInput().toString();
