...
class GridTestData {
  ...
  withStart(TimeUtil.withDefaults.toZonedDateTime("2020-03-24T15:11:31+01:00")).
  withEnd(TimeUtil.withDefaults.toZonedDateTime("2020-03-25T15:11:31+01:00")).build()
  ...
  Quantities.getQuantity(0d, RESISTANCE),
  Quantities.getQuantity(51.72750115394592d, REACTANCE),
  ...
  Quantities.getQuantity(1.5d, RESISTANCE),
  Quantities.getQuantity(15.5d, REACTANCE),
  ...
  "MS-NS_1",
  Quantities.getQuantity(10.078d, RESISTANCE),
  Quantities.getQuantity(23.312d, REACTANCE),
