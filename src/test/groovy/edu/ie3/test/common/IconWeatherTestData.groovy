...
class IconWeatherTestData extends WeatherTestData {
  ...
  Quantities.getQuantity(-5.0, StandardUnits.TEMPERATURE),
  Quantities.getQuantity(-4.0, StandardUnits.TEMPERATURE),
  )
  ...
  Quantities.getQuantity(-2.0, StandardUnits.TEMPERATURE),
  )
  ...
  Quantities.getQuantity(-1.0, StandardUnits.TEMPERATURE),
  Quantities.getQuantity(0.0, StandardUnits.TEMPERATURE),
  )
