...
class IconWeatherTestData extends WeatherTestData {
  ...
  Optional.of(Quantities.getQuantity(100.123456789123, StandardUnits.TEMPERATURE)),
  Optional.of(Quantities.getQuantity(200.123456789123, StandardUnits.TEMPERATURE))
  )
  ...
  Optional.of(Quantities.getQuantity(300.123456789123, StandardUnits.TEMPERATURE)),
  Optional.of(Quantities.getQuantity(400.123456789123, StandardUnits.TEMPERATURE))
  )
  ...
  Optional.of(Quantities.getQuantity(500.123456789123, StandardUnits.TEMPERATURE)),
  Optional.of(Quantities.getQuantity(600.123456789123, StandardUnits.TEMPERATURE))
  )
  ...
  Optional.of(Quantities.getQuantity(700.123456789123, StandardUnits.TEMPERATURE)),
  Optional.of(Quantities.getQuantity(800.123456789123, StandardUnits.TEMPERATURE))
  )
  ...
  Optional.of(Quantities.getQuantity(900.123456789123, StandardUnits.TEMPERATURE)),
  Optional.of(Quantities.getQuantity(1000.123456789123, StandardUnits.TEMPERATURE))
  )
}
