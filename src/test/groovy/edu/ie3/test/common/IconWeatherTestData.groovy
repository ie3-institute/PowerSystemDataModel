...
class IconWeatherTestData extends WeatherTestData {
	...
	COORDINATE_67775,
	Quantities.getQuantity(0.3562648859375, StandardUnits.IRRADIATION),
	Quantities.getQuantity(0.228021339757131, StandardUnits.IRRADIATION),
	...
	COORDINATE_67775,
	Quantities.getQuantity(0.20438963365625, StandardUnits.IRRADIATION),
	Quantities.getQuantity(0.20046049098038043, StandardUnits.IRRADIATION),
	...
	COORDINATE_67775,
	Quantities.getQuantity(0.175039569078125, StandardUnits.IRRADIATION),
	Quantities.getQuantity(0.18073429610400223, StandardUnits.IRRADIATION),
	...
	COORDINATE_67776,
	Quantities.getQuantity(0.3330547140625, StandardUnits.IRRADIATION),
	Quantities.getQuantity(0.24524079037841295, StandardUnits.IRRADIATION),
	...
	COORDINATE_67776,
	Quantities.getQuantity(0.09170939132297, StandardUnits.IRRADIATION),
	Quantities.getQuantity(0.241641483540946, StandardUnits.IRRADIATION),
