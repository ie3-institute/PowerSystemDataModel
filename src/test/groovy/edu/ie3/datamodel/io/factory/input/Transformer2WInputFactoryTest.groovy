...
class Transformer2WInputFactoryTest extends Specification implements FactoryTestHelper {
  ...
  def "A Transformer2WInputFactory should parse a valid Transformer2WInput correctly"() {
    ...
    when:
    Try<Transformer2WInput> input = inputFactory.get(new TypedConnectorInputEntityData<Transformer2WTypeInput>(parameter, inputClass, operatorInput, nodeInputA, nodeInputB, typeInput))
