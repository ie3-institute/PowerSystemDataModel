...
class CsvFileSinkTest extends Specification implements TimeSeriesTestData {
  ...
  def "A valid CsvFileSink should persist provided elements correctly"() {
    ...
    WecResult wecResult = new WecResult(uuid, TimeUtil.withDefaults.toZonedDateTime("2020-01-30T17:26:44+01:00"), inputModel, p, q)
    EvcsResult evcsResult = new EvcsResult(uuid, TimeUtil.withDefaults.toZonedDateTime("2020-01-30T17:26:44+01:00"), inputModel, p, q)
    EmResult emResult = new EmResult(uuid, TimeUtil.withDefaults.toZonedDateTime("2020-01-30T17:26:44+01:00"), inputModel, p, q)
    ...
    FlexOptionsResult flexOptionsResult = new FlexOptionsResult(uuid, TimeUtil.withDefaults.toZonedDateTime("2020-01-30T17:26:44+01:00"), inputModel, pRef, pMin, pMax)
