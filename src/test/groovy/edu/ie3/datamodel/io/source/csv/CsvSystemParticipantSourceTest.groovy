...
class CsvSystemParticipantSourceTest extends Specification implements CsvTestDataMeta {
    ...
    def "A CsvSystemParticipantSource should return data from a valid heat pump input file as expected"() {
        ...
        [sptd.hpInput.node] | []                      | [sptd.hpInput.type] | [sptd.hpInput.thermalBus] || 1             || [new HpInput(sptd.hpInput.uuid, sptd.hpInput.id, OperatorInput.NO_OPERATOR_ASSIGNED, sptd.hpInput.operationTime, sptd.hpInput.node, sptd.hpInput.thermalBus, sptd.hpInput.qCharacteristics, sptd.hpInput.type)]
        []                  | []                      | []                  | []                        || 0             || []
        [sptd.hpInput.node] | []                      | []                  | []                        || 0             || []
    ...
    def "A CsvSystemParticipantSource should return data from a valid chp input file as expected"() {
        ...
        [sptd.chpInput.node] | [sptd.chpInput.operator] | [sptd.chpInput.type] | [sptd.chpInput.thermalBus] | [sptd.chpInput.thermalStorage] || 1             || [sptd.chpInput]
        [sptd.chpInput.node] | []                       | [sptd.chpInput.type] | [sptd.chpInput.thermalBus] | [sptd.chpInput.thermalStorage] || 1             || [new ChpInput(sptd.chpInput.uuid, sptd.chpInput.id, OperatorInput.NO_OPERATOR_ASSIGNED, sptd.chpInput.operationTime, sptd.chpInput.node, sptd.chpInput.thermalBus, sptd.chpInput.qCharacteristics, sptd.chpInput.type, sptd.chpInput.thermalStorage, sptd.chpInput.marketReaction)]
        []                   | []                       | []                   | []                         | []                             || 0             || []
        [sptd.chpInput.node] | []                       | []                   | []                         | []                             || 0             || []
        [sptd.chpInput.node] | [sptd.chpInput.operator] | []                   | []                         | []                             || 0             || []
        [sptd.chpInput.node] | [sptd.chpInput.operator] | [sptd.chpInput.type] | []                         | []                             || 0             || []
    ...
    def "A CsvSystemParticipantSource should return data from valid ev input file as expected"() {
        ...
        [sptd.evInput.node] | []                      | [sptd.evInput.type] || 1             || [new EvInput(sptd.evInput.uuid, sptd.evInput.id, OperatorInput.NO_OPERATOR_ASSIGNED, sptd.evInput.operationTime, sptd.evInput.node, sptd.evInput.qCharacteristics, sptd.evInput.type)]
    ...
    def "A CsvSystemParticipantSource should return data from valid wec input file as expected"() {
        ...
        [sptd.wecInput.node] | []                       | [sptd.wecInput.type] || 1             || [new WecInput(sptd.wecInput.uuid, sptd.wecInput.id, OperatorInput.NO_OPERATOR_ASSIGNED, sptd.wecInput.operationTime, sptd.wecInput.node, sptd.wecInput.qCharacteristics, sptd.wecInput.type, sptd.wecInput.marketReaction)]
    ...
    def "A CsvSystemParticipantSource should return data from valid storage input file as expected"() {
        ...
        [sptd.storageInput.node] | []                           | [sptd.storageInput.type] || 1             || [new StorageInput(sptd.storageInput.uuid, sptd.storageInput.id, OperatorInput.NO_OPERATOR_ASSIGNED, sptd.storageInput.operationTime, sptd.storageInput.node, sptd.storageInput.qCharacteristics, sptd.storageInput.type, sptd.storageInput.behaviour.token)]
    ...
    def "A CsvSystemParticipantSource should return data from valid bm input file as expected"() {
        ...
        [sptd.bmInput.node] | []                      | [sptd.bmInput.type] || 1             || [new BmInput(sptd.bmInput.uuid, sptd.bmInput.id, OperatorInput.NO_OPERATOR_ASSIGNED, sptd.bmInput.operationTime, sptd.bmInput.node, sptd.bmInput.qCharacteristics, sptd.bmInput.type, sptd.bmInput.marketReaction, sptd.bmInput.costControlled, sptd.bmInput.feedInTariff)]
    ...
    def "A CsvSystemParticipantSource should return data from valid ev charging station input file as expected"() {
        ...
        when:
        csvSystemParticipantSource.getEvCS()

        then:
        NotImplementedException thrown = thrown(NotImplementedException)
        thrown.message.startsWith("Ev Charging Stations are not implemented yet!")
    ...
    def "A CsvSystemParticipantSource should return data from valid fixedFeedIn input file as expected"() {
        ...
        [sptd.fixedFeedInInput.node] | []                               || 1             || [new FixedFeedInInput(sptd.fixedFeedInInput.uuid, sptd.fixedFeedInInput.id, OperatorInput.NO_OPERATOR_ASSIGNED, sptd.fixedFeedInInput.operationTime, sptd.fixedFeedInInput.node, sptd.fixedFeedInInput.qCharacteristics, sptd.fixedFeedInInput.sRated, sptd.fixedFeedInInput.cosphiRated)]
