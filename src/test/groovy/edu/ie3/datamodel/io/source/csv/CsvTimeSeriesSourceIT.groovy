...
class CsvTimeSeriesSourceIT extends Specification implements CsvTestDataMeta {
	...
	def setup() {
		...
		source = new CsvTimeSeriesSource(";", timeSeriesFolderPath, new EntityNamingStrategy(), UUID.fromString("76c9d846-797c-4f07-b7ec-2245f679f5c7"), "its_ph_76c9d846-797c-4f07-b7ec-2245f679f5c7", HeatAndPValue, factory)
	}
	...
	def "Construction a csv time series source with malicious parameters, leads to IllegalArgumentException"() {
		when:
		new CsvTimeSeriesSource(";", timeSeriesFolderPath, new EntityNamingStrategy(), UUID.fromString("fbc59b5b-9307-4fb4-a406-c1f08f26fee5"), "file/not/found", HeatAndPValue, factory)
