...
class CsvGraphicSourceTest extends Specification implements CsvTestDataMeta {
  ...
  def "A CsvGraphicSource should process invalid input data as expected when requested to provide an instance of GraphicElements"() {
    ...
    ex.message == "Some exception(s) occurred while initializing graphic elements. \n" +
    "        edu.ie3.datamodel.exceptions.SourceException: 1 exception(s) occurred within \"LineGraphicInput\" data: \n" +
    "               edu.ie3.datamodel.exceptions.FactoryException: edu.ie3.datamodel.exceptions.SourceException: Entity with uuid 91ec3bcf-1777-4d38-af67-0bf7c9fa73c7 was not provided. Caused by: edu.ie3.datamodel.exceptions.SourceException: Entity with uuid 91ec3bcf-1777-4d38-af67-0bf7c9fa73c7 was not provided."
  }
