...
class FileTimeSeriesMetaInformationSourceIT extends Specification implements CsvTestDataMeta {
  @Shared
  FileTimeSeriesMetaInformationSource source

  def setupSpec() {
    source = new FileTimeSeriesMetaInformationSource(";", timeSeriesFolderPath, new FileNamingStrategy())
  }
