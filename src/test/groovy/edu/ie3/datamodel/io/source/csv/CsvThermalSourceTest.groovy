...
class CsvThermalSourceTest extends Specification implements CsvTestDataMeta {
	...
	def "A CsvThermalSource should return a ThermalHouseInput from valid and invalid input data as expected"() {
		...
		resultingThermalHouseWoOperator.first().desiredTemperature == ThermalUnitInputTestData.thermalHouseInput.desiredTemperature
		...
		resultingThermalHouse.first().desiredTemperature == ThermalUnitInputTestData.thermalHouseInput.desiredTemperature
