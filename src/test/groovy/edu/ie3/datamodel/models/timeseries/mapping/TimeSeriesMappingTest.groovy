...
class TimeSeriesMappingTest extends Specification {
	...
	def setupSpec() {
		...
		ts0.getUuid() >> UUID.fromString("b09af80e-d65c-4339-b5af-5504339a3180")
		ts1 = Mock(IndividualTimeSeries)
		ts1.getUuid() >> UUID.fromString("ae675233-89ac-4323-b951-df406491f2f0")
		ts2 = Mock(IndividualTimeSeries)
		ts2.getUuid() >> UUID.fromString("9c26cc08-3c6e-4ce5-98c5-e8a6925e665c")
		ts3 = Mock(IndividualTimeSeries)
		ts3.getUuid() >> UUID.fromString("b8a7e2e7-6f66-4aa5-9c36-6b6bb323b37c")
	}
	...
	def "The time series mapping is build correctly"() {
		...
		def expectedMapping = new HashMap()
