...
class IrradiationValueTest extends Specification {
    ...
    def "An Irradiation's equal method should work as expected on null and provided quantities"() {
        ...
        new IrradiationValue(Quantities.getQuantity(10230, PowerSystemUnits.WATTHOUR_PER_SQUAREMETRE), null) | new IrradiationValue(Quantities.getQuantity(10.23, StandardUnits.IRRADIATION), null) || false
    }
